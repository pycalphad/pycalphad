...
def check_output(model, variables, output, known_value, mode='sympy'):
    ...
    known_value = np.array(known_value, dtype=complex)
...
def test_ionic_liquid_energy_anion_sublattice():
    ...
    out = np.array(mod.ast.subs({**potentials, **em_FE_Sneg2}), dtype=complex)
    ...
    out = np.array(mod.ast.subs({**potentials, **em_FE_VA}), dtype=complex)
    ...
    out = np.array(mod.ast.subs({**potentials, **em_FE_S}), dtype=complex)
    ...
    out = np.array(mod.ast.subs({**potentials, **mix_equal}), dtype=complex)
    ...
    out = np.array(mod.ast.subs({**potentials, **mix_unequal}), dtype=complex)
    ...
    out = np.array(mod.ast.subs({**potentials, **eq_sf_1}), dtype=complex)
    ...
    out = np.array(mod.ast.subs({**potentials, **eq_sf_2}), dtype=complex)
