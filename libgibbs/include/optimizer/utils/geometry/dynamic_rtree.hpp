...
// Bounding tree (R tree) implementation with run-time dimensionality

#ifndef INCLUDED_rtree
#define INCLUDED_rtree
...
public:
    ...
    typedef geometry::model::dynamic_box<
                geometry::model::dynamic_point<
